...
B) Para gerar um número entre 1 e 3, podemos usar o código: let numeroAleatorio1a3 = parseInt(Math.random() * 4);.

C) Para gerar um número entre 1 e 3, podemos usar o código: let numeroAleatorio1a3 = parseInt(Math.random() * 3);.
...
A) let palavraPessoa = quantidadePessoas ? "pessoa" : "pessoas";

B) let palavraPessoa = quantidadePessoas == 1 ? "pessoa" ; "pessoas";

C) let palavraPessoa = if(quantidadePessoas == 1) ? "pessoa" : "pessoas";
